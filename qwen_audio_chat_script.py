...
def main():
    ...
    trace_path = f"traces/qwen_audio_chat_trace_{TYPE}_{dt_str}.json"
    ...
    # Save to CSV
    csv_filename = f"traces/qwen_audio_chat_benchmark_runs_{TYPE}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
