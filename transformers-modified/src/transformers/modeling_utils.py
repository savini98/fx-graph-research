...
class ModuleUtilsMixin:
    ...
    def get_extended_attention_mask(
        ...
        # GraphMend fix: Deferred Side Effects (Transformation #2)
        # Removed warnings.warn() — pure side effect that causes a graph break
        # (unsupported Python builtin _warnings.warn) with no computational value.
