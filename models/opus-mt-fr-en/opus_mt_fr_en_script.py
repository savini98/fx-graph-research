...
MODEL_ID = os.path.join(os.path.dirname(os.path.abspath(__file__)), "opus-mt-fr-en")
OUTPUT_TOKEN_LENGTH = 100  # Set your desired output token length limit here
PROMPT = "La recherche en intelligence artificielle a transformé de nombreuses industries, notamment la santé, la finance et les transports."
