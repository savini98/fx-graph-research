...
MODEL_ID = os.path.join(os.path.dirname(os.path.abspath(__file__)), "model_weights")
OUTPUT_TOKEN_LENGTH = 100  # Set your desired output token length limit here
PROMPT = "Riformula in modo inclusivo: Lo studente deve completare il suo compito entro domani."
