...
BATCH_SIZE = 2  # Set your desired batch size here (whisper-large-v3 is ~1.5B params, very memory-heavy)
MODEL_ID = os.path.join(os.path.dirname(os.path.abspath(__file__)), "whisper-large-v3")
...
def fixed_batch(processor, bs=1):
    ...
    Whisper-large-v3 expects input_features of shape (batch, 128, 3000) for 30s audio.
...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=2, help='Batch size for generation (default: 2)')
